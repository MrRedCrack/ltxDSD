...
\fancyfoot[RO,LE]{\thepage}           % page number in "outer" position of footer line
\fancyfoot[LO,RE]{\footnotesize{}Bachelor of Information Technology (Honours) Computer Engineering\\Faculty of Information and Communication Technology (Kampar Campus), UTAR}
\usepackage{lipsum}
\newcounter{cntA}
...
\clearpage
\fancyhead[LO,RE]{\footnotesize\slshape\nouppercase\leftmark}
