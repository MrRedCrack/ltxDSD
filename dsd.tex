...
\setminted[systemverilog]{
	...
	fontsize=\normalsize}
\usemintedstyle{bw}
\usepackage[labelfont=bf,position=auto,justification=centering]{caption} % Set caption options
...
\begin{titlepage}
	...
	\begin{center}
		...
		\begin{table}[ht]
			...
			\centering
			\begin{NiceTabular}[t]{llc>{\raggedright\arraybackslash}p{5cm}}[]%code-before = \rowcolor{white}{1} \rowcolors{2}{gray!12.5}{white}
				\toprule
...
\subfile{subfile/3sourcecode.tex}
\clearpage
